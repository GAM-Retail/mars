...
export function ReservationCalendarHeader(props: Readonly<ReservationCalendarHeaderProps>) {
  ...
  return (
    <div className={cn('flex items-center justify-between border-b p-2', props.class)}>
      <div className="flex items-center gap-2">
        <Button variant="outline" size="sm" onClick={navigateToday}>
          Today
        </Button>
        <div className="flex items-center">
          <Button variant="ghost" size="icon" onClick={navigatePrev} className="size-8">
            <svg
          ...
          <Button variant="ghost" size="icon" onClick={navigateNext} className="size-8">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="none"
