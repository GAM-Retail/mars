...
import { useScroll, useSpring, useTransform, type UseScrollOptions } from 'motion/react';

const SectionScrollContainerContext = createContext<RefObject<HTMLElement | null> | null>(null);
