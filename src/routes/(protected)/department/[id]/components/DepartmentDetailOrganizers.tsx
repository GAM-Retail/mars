...
export default function DepartmentDetailOrganizers(props: Readonly<Props>) {
  return (
    <div>
      <p class="text-xs text-muted-foreground mb-2">Organizers</p>
      {props.organizers.length === 0 ? (
        <p class="text-sm text-muted-foreground">No organizers are assigned to this department</p>
      ) : (
        <div class="relative">
